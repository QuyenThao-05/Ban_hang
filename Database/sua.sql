...
--4. PRODUCT (ĐÃ MAP TYPE)
INSERT INTO Product(Name, Price, Quantity, ProductTypeId, ManufacturerId) VALUES
(N'Bút bi TL-027',5000,100,1,1),
(N'Bút chì 2B',4000,150,1,8),
(N'Vở 200 trang',15000,80,2,2),
(N'Giấy A4 Double A',70000,50,3,18),
(N'Kẹp giấy nhỏ',10000,200,5,3),
(N'Bìa hồ sơ giấy',5000,120,5,15),
(N'Bút dạ bảng',12000,90,1,9),
(N'Bút màu 12 cây',45000,60,1,5),
(N'Thước 20cm',8000,110,4,3),
(N'Tẩy trắng',3000,130,4,6),
(N'Ghim bấm',15000,75,5,4),
(N'Băng keo 2cm',7000,140,5,3),
(N'Sổ tay mini',20000,70,2,10),
(N'Bút lông dầu',13000,85,1,9),
(N'Giấy note vàng',9000,160,3,11),
(N'Bút gel mực xanh',6000,120,1,1),
(N'Kéo văn phòng',25000,50,4,3),
(N'Compa học sinh',30000,40,4,8),
(N'Hồ dán',7000,90,5,14),
(N'Bảng viết mini',50000,30,5,7);
